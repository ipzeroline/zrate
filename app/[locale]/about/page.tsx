...
const ABOUT_CONTENT: Record<LanguageCode, {
  ...
  th: {
    ...
    faqs: [
      ...
      { q: 'ข้อมูลอัตราแลกเปลี่ยนดึงมาจากไหน?', a: 'ข้อมูลทั้งหมดอ้างอิงแบบเรียลไทม์จากระบบ ExchangeRate-API ซึ่งประมวลผลจากราคาอ้างอิงในตลาดการเงินและสถาบันการเงินทั่วโลก' },
  ...
  en: {
    ...
    faqs: [
      ...
      { q: 'Where does the exchange rate data come from?', a: 'All data is retrieved in real-time from ExchangeRate-API, which compiles market data from global financial institutions.' },
  ...
  lo: {
    ...
    faqs: [
      ...
      { q: 'ຂໍ້ມູ້ນດຶງມາຈາກໃສ?', a: 'ດຶງມາແບບສົດໆຈາກ ExchangeRate-API ທີ່ປະມວນຜົນຂໍ້ມູ້ນຈາກຕະຫຼາດການເງິນທົ່ວໂລກ.' },
  ...
  my: {
    ...
    faqs: [
      ...
      { q: 'ငွေလဲနှုန်းဒေတာ ဘယ်ကရလဲ။', a: 'ကမ္ဘာလုံးဆိုင်ရာ ဘဏ္ဍာရေးအချက်အလက်များကို စုစည်းပေးသော ExchangeRate-API မှ တိုက်ရိုက်ရယူသည်။' },
  ...
  km: {
    ...
    badges: ['បម្លែងលុយភ្លាមៗ', 'អត្រាទីផ្សារ', 'ស្ថិតិលុយสด', 'មគ្គុទ្ទេសក៍ផ្ញើលុយ', 'គូរូបិយប័ណ្ណអាស៊ាន'],
    features: [
    ...
    faqs: [
      ...
      { q: 'តើទិន្នន័យអត្រាប្តូរប្រាក់បានមកពីណា?', a: 'ទិន្នន័យទាំងអស់ត្រូវបានទាញយកតាមពេលវេលាពិតពី ExchangeRate-API ដែលប្រមូលផ្តុំពីទីផ្សារហិរញ្ញវត្ថុទូទាំងពិភពលោក។' },
